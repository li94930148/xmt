...
const keys = ['account_scope_hash','collected_at','works_seen','works_with_candidates','works_without_candidates','candidates_seen','probe_summary','ttl_summary','execution_status','termination_reason','diagnostics'] as const;
