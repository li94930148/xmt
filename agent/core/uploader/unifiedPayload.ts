...
export type UnifiedCreatorPayload = {
  ...
  page_schemas: JsonRecord[];
  sync_task: JsonRecord;
};

export function toUnifiedCreatorPayload(snapshot: CreatorSnapshot, options: { knownContentIds?: Set<string>; capabilities?: PageCapability[]; taskId?: string } = {}): UnifiedCreatorPayload {
