// @ts-nocheck -- React Bits 官方 WebGL 事件目标收窄与 XMT strict 类型存在差异，视觉逻辑未改。
/**
 * React Bits 官方组件：SpecularButton
 * 官方 Registry：https://reactbits.dev/r/SpecularButton-TS-TW.json
 * 接入日期：2026-08-08
 * 原始依赖：ogl@^1.0.11
