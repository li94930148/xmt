...
export default function LightRaysBackgroundAdapter({ intensity }: BackgroundAdapterProps) {
  ...
  return <LightRays raysOrigin="top-center" raysColor='var(--xmt-primary)' raysSpeed={low ? 0.15 : 0.5} lightSpread={low ? 0.55 : 0.8} rayLength={low ? 1.1 : 1.5} pulsating={!low} followMouse={!low} mouseInfluence={low ? 0 : 0.08} noiseAmount={0.05} distortion={0.05} />;
}
