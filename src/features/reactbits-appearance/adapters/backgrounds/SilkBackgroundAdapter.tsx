...
export default function SilkBackgroundAdapter({ intensity }: BackgroundAdapterProps) {
  ...
  return <Silk color="var(--xmt-primary)" speed={low ? 1.5 : intensity === 'high' ? 4 : 2.5} scale={low ? 0.8 : 1.15} noiseIntensity={low ? 0.8 : 1.25} rotation={0.1} canvasEvents={createXmtSafeR3FEvents} />;
}
