...
export default function WavesBackgroundAdapter({ intensity }: BackgroundAdapterProps) {
  ...
  return <Waves lineColor='var(--xmt-primary)' backgroundColor="transparent" waveSpeedX={low ? 0.004 : 0.012} waveSpeedY={low ? 0.002 : 0.006} waveAmpX={low ? 12 : 28} waveAmpY={low ? 8 : 16} />;
}
