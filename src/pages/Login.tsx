...
export default function Login() {
              ...
              <div className="relative z-10 px-16 max-w-xl">
                <div className={`transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <div className="mb-12 flex items-center gap-4">
                    <div className="flex h-12 w-12 items-center justify-center overflow-hidden border border-[#c8a832]/40">
                      <BrandMark settings={settings} roundedClass="" textClass="text-[#c8a832]" />
                    </div>
                    <div className="h-px w-16 bg-[#c8a832]/30" />
                    <span className="text-[#c8a832]/60 text-xs tracking-[0.3em] uppercase font-medium">{brandName}</span>
                  </div>
                </div>

                <div className={`transition-all duration-1000 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <h1 className="mb-4 text-[clamp(3rem,8vw,7rem)] font-extralight leading-[0.9] tracking-tight text-white/90">
                    {settings.system.name}
                  </h1>
                  <p className="max-w-md text-white/30 text-lg leading-relaxed font-light">{brandDescription}</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[45%] flex items-center justify-center relative">
              <div className={`w-full max-w-[400px] px-8 lg:px-0 transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                ...
                <div className="mt-12 text-center">
                  <p className="text-white/10 text-[10px] tracking-widest uppercase">{settings.system.name}</p>
                </div>
              </div>
            </div>
          </div>
  ...
  }, [brandDescription, brandName, commonFormProps, layout, mounted, settings, welcomeTitle]);
