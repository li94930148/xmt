...
import ResourceCreateModal from '@/components/resource-center/ResourceCreateModal';
...
export default function ResourceLibrary({ fixedLibraryType }: { fixedLibraryType?: LibraryType }) {
  ...
  return <PageShell>
    ...
    <ResourceCreateModal open={creating} libraryType={type} categories={categories} onClose={() => setCreating(false)} onCreated={(id) => navigate(`/asset-center/resources/${id}`)} />
  </PageShell>;
}
