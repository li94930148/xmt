...
window.fetch = async (input, init) => {
  ...
  return new Response(JSON.stringify({
    ...
    data: {
      ...
      metrics: {
        lastHour: { windowMinutes: 60, from: now, to: now, categories: { login: 18, refresh: 0, logout: 3, failure: 0 }, counters: { legacy_login_count: 18, v1_login_count: 0, refresh_success: 0, refresh_failed: 0, csrf_failed: 0, token_reuse_detected: 0, logout_success: 3, expired_count: 0 }, refreshFailureRate: 0 },
        last24Hours: { windowMinutes: 1440, from: now, to: now, categories: { login: 126, refresh: 0, logout: 21, failure: 0 }, counters: { legacy_login_count: 126, v1_login_count: 0, refresh_success: 0, refresh_failed: 0, csrf_failed: 0, token_reuse_detected: 0, logout_success: 21, expired_count: 0 }, refreshFailureRate: 0 },
      },
