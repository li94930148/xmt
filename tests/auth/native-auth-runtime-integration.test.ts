...
const response = {
  ...
  data: {
    ...
    session: { id: 'session', clientType: 'android', deviceName: 'XMT Android', appVersion: '2.20.2', createdAt: '2026-01-01', lastSeenAt: '2026-01-01', idleExpiresAt: '2026-01-02', absoluteExpiresAt: '2026-01-31', current: true },
  },
};
