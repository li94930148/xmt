...
const expected = { version: '2.19.10', versionCode: 21910, platform: 'android', target: 'production', apiBaseUrl: 'https://lanyaomedia.com/api', socketBaseUrl: 'https://lanyaomedia.com' };
