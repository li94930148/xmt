...
assert.deepEqual(manifest, { version: '2.20.2', versionCode: 22002, platform: 'android', target: 'production', apiBaseUrl: 'https://lanyaomedia.com/api', socketBaseUrl: 'https://lanyaomedia.com' });
